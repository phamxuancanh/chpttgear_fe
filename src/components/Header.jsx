                        ...
                        <div className="w-full flex items-center justify-between h-16">
                            ...
                            <div className="hidden lg:flex items-center space-x-3 xl:space-x-5">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <div className="p-1.5 xl:p-2 flex items-center gap-2 border border-white rounded-lg">
                                            {isLoggedIn ? (
                                                <>
                                                    <img
                                                    ...
                                                    />
                                                    <div className="hidden xl:flex flex-col max-w-[140px]">
                                                        <span className="text-xs text-white">Xin chào</span>
                                                        <span className="font-bold text-sm text-white whitespace-nowrap overflow-hidden text-ellipsis">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <div className="font-bold text-sm text-white hidden xl:block">Đăng nhập</div>
                                                </div>
                                            )}
                                        </div>
                                    </button>
                                    {showUserDropdown && user && (
                                        <div className="absolute z-50 -right-4 mt-2 w-48 rounded-md shadow-lg bg-white text-black">
                                            {!user ? (
                                                <>
                                                    <Link
                                                        onClick={handleLinkClick}
                                ...
                                <div className="w-full px-3 py-2">
                                    ...
                                    >
                                        <div className="flex items-center space-x-2">
                                            <div className="flex items-center space-x-2 border border-white rounded-lg">
                                                {user ? (
                                                    <>
                                                        <img
                                                        ...
                                                        <div className="flex flex-col">
                                                            <div>Xin chào</div>
                                                            <div className="font-bold max-w-[180px] whitespace-nowrap overflow-hidden text-ellipsis">
                                                                {user.firstName || user.lastName ? `${user.firstName} ${user.lastName}` : user.username}
                                                            </div>
                                                        </div>
                                                    </>
                                    ...
                                    {isDropdownOpenUser && (
                                        <div className="w-full px-3 rounded-md mt-1">
                                            {!user ? (
                                                <>
                                                    <Link
                                                        onClick={handleLinkClick}
                                                        to="/login"
                                                        className="block w-full px-4 py-2 text-sm font-medium text-gray-200 hover:bg-gray-800 transition duration-300 rounded-md"
                                                    >
                                                        Đăng nhập
                                                    </Link>
                                                    <Link
                                                ...
                                                <div className="bg-red-500">
                                                    <Link
                                                        onClick={handleLinkClick}
                                                        to="/profile"
                                                        className="block w-full py-2 text-sm font-medium text-gray-200 hover:bg-gray-800 transition duration-300 rounded-md"
                                                    >
                                                        Hồ sơ
                                                    </Link>
                                                    <Link
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-left w-full px-4 py-2 text-sm font-medium text-gray-200 hover:bg-gray-800 transition duration-300 rounded-md"
                                                    >
                                                        Đăng xuất
                                                    </button>
                                                </div>
